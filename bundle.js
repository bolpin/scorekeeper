...
var _user$project$Main$newPlayerId = function (players) {
	return _elm_lang$core$List$length(players);
};
		...
		var newPlayers = A2(
			...
			function (player) {
				return _elm_lang$core$Native_Utils.eq(player.id, id) ? _elm_lang$core$Native_Utils.update(
					player,
					{name: model.input}) : player;
			},
			model.players);
		return _elm_lang$core$Native_Utils.update(
			model,
			{players: newPlayers, plays: newPlays, input: '', playerId: _elm_lang$core$Maybe$Nothing});
	});
...
var _user$project$Main$totalSection = function (model) {
	var total = A2(
		_elm_lang$core$List$map,
		function (_) {
			return _.points;
...
var _user$project$Main$Model = F4(
	function (a, b, c, d) {
		return {players: a, input: b, playerId: c, plays: d};
	});
...
var _user$project$Main$addPlayer = function (model) {
	var newPlayer = A3(
		...
		_user$project$Main$newPlayerId(model.players),
		model.input,
		0);
...
var _user$project$Main$save = function (model) {
	...
	if (_p0.ctor === 'Nothing') {
		...
		return A2(_user$project$Main$updatePlayer, model, _p0._0);
	}
};
		...
		switch (_p1.ctor) {
			...
			case 'Cancel':
				return _elm_lang$core$Native_Utils.update(
					...
					{input: ''});
			case 'Save':
				return _elm_lang$core$Native_Utils.eq('', model.input) ? model : _user$project$Main$save(model);
			case 'Edit':
				var _p2 = _p1._0;
				return _elm_lang$core$Native_Utils.update(
					model,
...
var _user$project$Main$Play = F4(
	function (a, b, c, d) {
		return {id: a, playerName: b, playerId: c, points: d};
	});
...
var _user$project$Main$renderPlayers = function (players) {
	return A2(
...
var _user$project$Main$playersListSection = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _user$project$Main$renderPlayers(model.players),
			_1: {ctor: '[]'}
		});
};
var _user$project$Main$Save = {ctor: 'Save'};
var _user$project$Main$formSection = function (model) {
	return A2(
...
var _user$project$Main$view = function (model) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_1: {
				ctor: '::',
				_0: _user$project$Main$playersListSection(model),
				_1: {
					ctor: '::',
					_0: _user$project$Main$totalSection(model),
					_1: {
						ctor: '::',
						_0: _user$project$Main$formSection(model),
						_1: {ctor: '[]'}
					}
				}
			}
